				...
				<div class="ContentMainPage">
					<div class="leftContentMainContainer">
						<div class="upperleftContentMainContainer">
									...
									<div class="css-0">
										...
										<div class="ContentOverviewInfo">
											...
											<div class="ContentOverviewInfo2">
												<span class="Text-Separator-ContentOverviewInfo">${con.webtoon_tag1}</span>
												<img alt="메타데이터 구분점"
							...
							<div class="Shortcuts">
								<form action="/user/wish_ok" method="POST">
									<input type="hidden" name="title" value="${con.webtoon_title}" />
									<input type="hidden" name="thumbnail"
										value="${con.webtoon_thumbnail}" />
									<button type="submit" name="submit" class="ShortcutsMainAction">찜하기</button>
								</form>
							</div>
						</div>
								...
								<div class="Main-Tab">
									<div class="MainTabIntroduction1">
										<div class="MainTabIntroduction2">
											<span class="MainTab-title-Introduction">${con.webtoon_title}</span><span
												class="MainTabIntroduction3">의 작품소개</span>
												...
												<div class="CommentInputField2">
													<div class="CommentInputField3">
														<div class="CommentInputField4">
															<textarea name="review_cont" placeholder="댓글을 입력해 주세요."
																class="Textarea-CommentInputField" style="height: auto;"></textarea>
																...
																<sec:authorize access="hasAnyRole('ROLE_MEMBER','ROLE_ADMIN')">
																	<div class="Del-comment1">
																		<input class="Del-Comment2" type="button" size="20"
																			value="삭제"
																			onclick="location='review_del?review_no=${rev.review_no}&review_thumbnail=${rev.review_thumbnail }&review_id=${rev.review_id }';" />
																	</div>
																</sec:authorize>
															</div>
														</div>
