...
<link rel="stylesheet" type="text/css"
	href="/resources/css/insert/webtooninsert.css">
...
<body>
	<div class="wrap">
		<header>
			<div class="header-div">
				...
				<div class="login-join">
					<a href="../Login/login.jsp" class="login">로그인 </a> | <a
						href="../join/join.jsp" class="join"> 회원가입</a>
				</div>
		...
		<div class="whale">
			...
			<!-- --------------------------------------------------------------------------- -->
			<form method="post" action="/webinsert3"
