...
<link rel="stylesheet" type="text/css" href="/resources/css/admin/boardmanager.css">
<script src="/resources/js/jquery.js"></script> 
<script type="text/javascript">
	typeChange5();
	function typeChange5(){
		$.getJSON("/admin/boardmanager5",function(data){
				$str="";
				$str+="<tr class='headers'>"
					+"<th>글번호</th>"
					+"<th>제목</th>"
					+"<th>조회수</th>"
					+"</tr>";
					$(data).each(function(){
						$str+=
							"<tr>"
							+"<td>"+this.board_no+"</td>"
							+"<td><a href='boardCorriger/"+this.board_no+"'>"+this.board_title+"</a></td>"
